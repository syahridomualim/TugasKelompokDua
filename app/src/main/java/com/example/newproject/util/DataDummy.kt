    ...
    fun generateDummyUniversity(): List<University> {
        ...
        universities.add(
            University(
                ...
                "Universitas Gadjah Mada (Hanacaraka: ꦈꦤꦶꦮ꦳ꦼꦂꦱꦶꦠꦱ꧀\u200Bꦒꦗꦃ\u200Bꦩꦢ; disingkat UGM) merupakan universitas negeri di Indonesia yang didirikan oleh Pemerintah Republik Indonesia pada tanggal 19 Desember 1949 berdasarkan Peraturan Pemerintah Nomor 23 Tahun 1949 tentang Peraturan Tentang Penggabungan Perguruan Tinggi Menjadi Universiteit tanggal 16 Desember 1949.",
